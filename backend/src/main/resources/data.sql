INSERT INTO Users(id, username, provider_id, nickname, profile_image_url, major_type, created_date, last_modified_date)
VALUES (1, 'enduf768640@kakao.com', 'kakao', '김두열', 'https://sample-image.png', 'MAJOR', now(), now()),
       (2, 'ofekim0@naver.com', 'kakao', '이정준', 'https://sample-image.png', 'MAJOR', now(), now()),
