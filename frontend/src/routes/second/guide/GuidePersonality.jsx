    ...
    <>
      ...
      <div className="container mx-auto p-5 max-w-3xl bg-gray-50 rounded-lg shadow-lg mt-10">
        ...
        <div className="content px-10">
          <h1 className="title text-3xl mt-12 mb-10 font-bold text-center text-gray-800">인성 면접 가이드</h1>
          <div className="text text-base mb-5 text-gray-700 leading-loose">
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>인성 모의 면접은 에세이 기반으로 진행됩니다.</li>
              <li>모의면접 참여인원이 1인일 경우, AI 면접이 진행됩니다.</li>
              <li>2인 이상일 경우 다대일 비대면 면접이 진행됩니다.</li>
              <li>2인 이상일 경우 역할(면접자, 면접관)이 교대되면서 진행됩니다.</li>
              <li>1분 자기소개를 비롯하여, 본인이 작성한 에세이를 기반으로 AI 기반의 질의응답이 이루어집니다.</li>
            </ul>
