                ...
                <div className="container mx-auto">
                    ...
                    <div className="flex">
                        ...
                        <div className="w-1/4 p-4 bg-white shadow rounded">
                            ...
                            <div className="mb-4">
                                <input type="text" placeholder="검색어를 입력하세요" className="w-full border p-2 rounded" />
                            </div>
                            <div className="mb-4">
                            ...
                            <button className="w-full bg-blue-600 text-white p-2 rounded">검색하기</button>
                        </div>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="bg-white shadow rounded p-4">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-sm bg-green-200 text-green-800 py-1 px-2 rounded">모집중</span>
                                        <span className="text-sm bg-purple-200 text-purple-800 py-1 px-2 rounded">PT</span>
                                    </div>
                                    <p className="text-gray-700">전공자 PT 준비방</p>
                                    <p className="text-gray-500 text-sm">열심히 모의 면접 해서 붙어봅시다!</p>
                                    <div className="mt-4 flex justify-between items-center">
                                        <span className="text-sm text-gray-600">1/3</span>
                                        <button className="bg-blue-600 text-white py-1 px-2 rounded">참여</button>
                                    </div>
                                </div>
                                {/* 추가 방 */}
                                {/* <Link to="createroom" className="bg-white shadow rounded p-4 flex items-center justify-center text-gray-400">+ 방 생성</Link> */}
                                <button onClick={onClickButton} className="bg-white shadow rounded p-4 flex items-center justify-center text-gray-400">+ 방 생성</button>
                            </div>
                        </div>
                    </div>
                </div>
