  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center my-10'>
        <span className="text-2xl font-semibold text-center">{roomContent.title}</span>
        <div className='mt-4 flex flex-col items-start'>
          <span className="text-md text-gray-600">시행 일자 | {roomContent.create}</span>
          <span className="text-md text-gray-600 mt-1">질답 횟수 | {roomContent.count}회</span>
        </div>
          ...
          {allContent.map((content, index) => (
            ...
            >
              <Card className="mb-5 w-full shadow-none">
                <div className='flex'>
                  <div className='flex'>
                    {content.expression.map((exp, expIndex) => (
                      <div key={expIndex} className='flex flex-col items-center'>
                        <img src={exp.img} alt="expression" className="w-10 h-10 mr-2" style={{ filter: 'invert(100%)' }} />
                  ...
                  <div className='ml-auto flex flex-col items-end pt-2'>
                    <div>
                      ...
                      <span className='font-bold text-xl'>{content.pronscore}</span>
                    </div>
                  </div>
                </div>
